...
const Navbar = () => {
    ...
    // when we have token then logged and when token is not set then log out
            ...
            <div className='flex items-center gap-4'>
                    ...
                    token
                        ? <div className='flex items-center gap-2 cursor-pointer group relative'>
                            ...
                            <div className='absolute top-8 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
                                <div className='min-w-48 bg-stone-100 roundes flex flex-col gap-4 p-4'>
                ...
                <div className={`${showMenu ? 'fixed w-full h-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white `}>
                    ...
                    <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
                        ...
                        {/* <NavLink onClick={() => setShowMenu(false)} to='/contact'><p className='px-4 py-2 rounded inline-block'>About</p></NavLink> */}
                    </ul>
                </div>
